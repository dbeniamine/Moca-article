...
\newcommand{\MocaPin}{\emph{MOCA}\xspace}
...
\begin{abstract}
    ...
    provide an over\-view of the memory patterns involved by the execution.

    In this study we present \Moca an efficient tool for spatiotemporal memory traces collection.
    It is based on a Linux kernel module and provides a complete coarse grained over\-view
