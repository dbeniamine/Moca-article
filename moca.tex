...
\DB{HPCS: 8 pages !!\url{http://hpcs2016.cisedu.info/1-call-for-papers},
track: \\
Soft and middleware:``Software Development Tools and Support'' ``Software Monitoring
and Measurement'' ``Operating Systems and Support'' ``Benchmarking and
Assessment'' \\
archi and sys: ``HPC Monitoring \& Instrumentation'' ``Memory, Storage, and
Warehousing''\\
