...
one page. It also intercept every calls to \texttt{malloc} family functions an
names malloced structures according to their call path. The overhead of this
data instrumentation is discussed in section~\ref{sec:expe-ovh}
