...
and writes
%\GH{N'y a-t-il pas une entrée par accès ???}\DB{Si, j'ai fait une petite modif pour clarifier}
). Moreover for both chunks and accesses a bitmask indicate on which
