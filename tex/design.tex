...
To ease the trace analysis, \Moca is also able to retrieve data structure
names, addresses and size. This is done (on demand) using a Pin~\cite{Luk05Pin}
...
instrumentation adds mainly a constant overhead when pin opens a binary and on
every allocations. This overhead is evaluated in section~\ref{sec:expe-ovh}
