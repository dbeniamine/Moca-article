...
understand correction and performance issues in a multithreaded application. However, these tools
...
include information about time, space (at which address the event occurs) and nature of access (is this
